...
namespace Lab01Sample01.Models
{
    ...
    public class DataSource
    {
        ...
        public void Initialize()
        {
            ...
            {
                new Book(){  MainAuthor = new Author() {  Addresses = new Address[] { new Address() {  County = "LangFang" }  }, AuthorName= "Awesome Yuer"} , StringList = new string[] { "a", "b" },  ClassList = new Translator[] { Translators[0], Translators[1] } ,     ID = 1, Isbn = "AA0011", Title = "Book 1", Year = 2000, ForKids = false, Authors = new List<Author>(){Authors[0], Authors[1]}, Translators = new List<Translator>(){Translators[0], Translators[1]}},
                new Book(){  MainAuthor = new Author() {  Addresses = new Address[] { new Address() {  County = "LangFang" }  }, AuthorName= "Awesome Yuer"} , StringList = new string[] { "a", "b" },  ClassList = new Translator[] { Translators[0], Translators[1] } ,     ID = 2, Isbn = "BB0011", Title = "Book 2", Year = 2001, ForKids = true, Authors = new List<Author>(){Authors[4], Authors[1], Authors[2]}, Translators = new List<Translator>(){Translators[0], Translators[2]}},
                new Book(){  MainAuthor = new Author() {  Addresses = new Address[] { new Address() {  County = "LangFang" }  }, AuthorName= "Awesome Yuer"} , StringList = new string[] { "a", "b" },  ClassList = new Translator[] { Translators[0], Translators[1] } ,     ID = 3, Isbn = "CC0011", Title = "Book 3", Year = 2002, ForKids = false, Authors = new List<Author>(){Authors[2], Authors[3]}, Translators = new List<Translator>(){Translators[3], Translators[1]}},
                new Book(){  MainAuthor = new Author() {  Addresses = new Address[] { new Address() {  County = "LangFang" }  }, AuthorName= "Awesome Yuer"} , StringList = new string[] { "a", "b" },  ClassList = new Translator[] { Translators[0], Translators[1] } ,     ID = 4, Isbn = "DD0011", Title = "Book 4", Year = 2003, ForKids = true, Authors = new List<Author>(){Authors[0], Authors[1], Authors[1]}, Translators = new List<Translator>(){Translators[4], Translators[2]}},
                new Book(){  MainAuthor = new Author() {  Addresses = new Address[] { new Address() {  County = "LangFang" }  }, AuthorName= "Awesome Yuer"} , StringList = new string[] { "a", "b" },  ClassList = new Translator[] { Translators[0], Translators[1] } ,     ID = 5, Isbn = "EE0011", Title = "Book 5", Year = 2004, ForKids = true, Authors = new List<Author>(){Authors[0], Authors[4], Authors[3]}, Translators = new List<Translator>(){Translators[5], Translators[4]}},
                new Book(){  MainAuthor = new Author() {  Addresses = new Address[] { new Address() {  County = "LangFang" }  }, AuthorName= "Awesome Yuer"} , StringList = new string[] { "a", "b" },  ClassList = new Translator[] { Translators[0], Translators[1] } ,     ID = 6, Isbn = "FF0011", Title = "Book 6", Year = 2005, ForKids = true, Authors = new List<Author>(){Authors[3], Authors[1]}, Translators = new List<Translator>(){Translators[6], Translators[3]}},
                new Book(){  MainAuthor = new Author() {  Addresses = new Address[] { new Address() {  County = "LangFang" }  }, AuthorName= "Awesome Yuer"} , StringList = new string[] { "a", "b" },  ClassList = new Translator[] { Translators[0], Translators[1] } ,     ID = 7, Isbn = "GG0011", Title = "Book 7", Year = 2006, ForKids = true, Authors = new List<Author>(){Authors[0], Authors[1], Authors[2]}, Translators = new List<Translator>(){Translators[4], Translators[0]}},
                new Book(){  MainAuthor = new Author() {  Addresses = new Address[] { new Address() {  County = "LangFang" }  }, AuthorName= "Awesome Yuer"} , StringList = new string[] { "a", "b" },  ClassList = new Translator[] { Translators[0], Translators[1] } ,     ID = 8, Isbn = "HH0011", Title = "Book 8", Year = 2007, ForKids = false, Authors = new List<Author>(){Authors[3], Authors[4]}, Translators = new List<Translator>(){Translators[2], Translators[5]}},
            });
        }
    }
}
